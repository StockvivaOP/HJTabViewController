#
#  Be sure to run `pod spec lint HJTabViewController.podspec' to ensure this is a
...
>>>>>>> 7937b0dbd97a642acb793d3274e8fbdead76c726
  ...
  s.description  = <<-DESC
  A Cool PageViewController, http://www.olinone.com
                   DESC
  ...
  # Or just: s.author    = "panghaijiao"
  # s.authors            = { "panghaijiao" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/panghaijiao"
  ...
  s.source_files  = "HJTabViewController"
